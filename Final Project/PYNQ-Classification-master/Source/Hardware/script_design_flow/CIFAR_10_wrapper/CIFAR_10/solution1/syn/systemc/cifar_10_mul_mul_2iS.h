...
// ==============================================================
#ifndef __cifar_10_mul_mul_2iS__HH__
#define __cifar_10_mul_mul_2iS__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cifar_10_mul_mul_2iS) {
    ...
    SC_CTOR(cifar_10_mul_mul_2iS):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
