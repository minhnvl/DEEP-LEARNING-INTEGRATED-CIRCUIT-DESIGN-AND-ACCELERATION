set lang "C++"
set moduleName "cifar_10"
set moduleIsExternC "0"
set rawDecl ""
set globalVariable ""
set PortList ""
set PortName0 "in_stream"
set BitWidth0 "64"
set ArrayOpt0 ""
set Const0 "0"
set Volatile0 "0"
...
set DataType0 [list "AXI_DMA_IO" "struct AXI_DMA_IO" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
...
set DataType1 [list "AXI_DMA_IO" "struct AXI_DMA_IO" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
