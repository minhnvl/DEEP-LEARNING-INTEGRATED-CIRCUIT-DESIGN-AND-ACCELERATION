set moduleName pool_2u_32u_16u_s
...
set C_modelName {pool<2u, 32u, 16u>}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5"],
		...
		"Port" : [
			...
			{"Name" : "IFMCH_curr_2", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "IFMDim_curr_2", "Type" : "OVld", "Direction" : "IO"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.buf_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.acc_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.cifar_10_mul_32s_bkb_U103", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.cifar_10_mul_32s_bkb_U104", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.cifar_10_mul_32s_bkb_U105", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	pool_2u_32u_16u_s {
		in_V_V {Type I LastRead 43 FirstWrite -1}
		out_V_V {Type O LastRead -1 FirstWrite 0}
		IFMCH_curr_2 {Type IO LastRead -1 FirstWrite -1}
		IFMDim_curr_2 {Type IO LastRead -1 FirstWrite -1}}}
