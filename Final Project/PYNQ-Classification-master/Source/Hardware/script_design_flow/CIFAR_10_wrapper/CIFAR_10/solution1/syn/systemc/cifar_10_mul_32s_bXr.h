...
// ==============================================================
#ifndef __cifar_10_mul_32s_bXr__HH__
#define __cifar_10_mul_32s_bXr__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cifar_10_mul_32s_bXr) {
    ...
    SC_CTOR(cifar_10_mul_32s_bXr):  ACMP_smul_su_U ("ACMP_smul_su_U") {
