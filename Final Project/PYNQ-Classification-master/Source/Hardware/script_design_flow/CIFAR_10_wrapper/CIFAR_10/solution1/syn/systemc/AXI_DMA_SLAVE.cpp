...
const sc_lv<15> AXI_DMA_SLAVE::ap_ST_fsm_state1 = "1";
const sc_lv<15> AXI_DMA_SLAVE::ap_ST_fsm_state2 = "10";
const sc_lv<15> AXI_DMA_SLAVE::ap_ST_fsm_state3 = "100";
const sc_lv<15> AXI_DMA_SLAVE::ap_ST_fsm_state4 = "1000";
const sc_lv<15> AXI_DMA_SLAVE::ap_ST_fsm_state5 = "10000";
const sc_lv<15> AXI_DMA_SLAVE::ap_ST_fsm_state6 = "100000";
const sc_lv<15> AXI_DMA_SLAVE::ap_ST_fsm_state7 = "1000000";
const sc_lv<15> AXI_DMA_SLAVE::ap_ST_fsm_state8 = "10000000";
const sc_lv<15> AXI_DMA_SLAVE::ap_ST_fsm_state9 = "100000000";
const sc_lv<15> AXI_DMA_SLAVE::ap_ST_fsm_state10 = "1000000000";
const sc_lv<15> AXI_DMA_SLAVE::ap_ST_fsm_pp0_stage0 = "10000000000";
const sc_lv<15> AXI_DMA_SLAVE::ap_ST_fsm_state13 = "100000000000";
const sc_lv<15> AXI_DMA_SLAVE::ap_ST_fsm_state14 = "1000000000000";
const sc_lv<15> AXI_DMA_SLAVE::ap_ST_fsm_state15 = "10000000000000";
const sc_lv<15> AXI_DMA_SLAVE::ap_ST_fsm_pp1_stage0 = "100000000000000";
...
const sc_lv<32> AXI_DMA_SLAVE::ap_const_lv32_E = "1110";
...
const sc_lv<32> AXI_DMA_SLAVE::ap_const_lv32_D = "1101";
...
AXI_DMA_SLAVE::AXI_DMA_SLAVE(sc_module_name name) : sc_module(name), mVcdFile(0) {
    cifar_10_mul_32s_bkb_U1 = new cifar_10_mul_32s_bkb<1,1,32,32,32>("cifar_10_mul_32s_bkb_U1");
    cifar_10_mul_32s_bkb_U1->din0(tmp_data_V_5_reg_182);
    cifar_10_mul_32s_bkb_U1->din1(tmp_data_V_2_reg_164);
    cifar_10_mul_32s_bkb_U1->dout(KER_size_0_fu_113_p2);
    cifar_10_mul_32s_bkb_U2 = new cifar_10_mul_32s_bkb<1,1,32,32,32>("cifar_10_mul_32s_bkb_U2");
    cifar_10_mul_32s_bkb_U2->din0(tmp_data_V_4_reg_176);
    cifar_10_mul_32s_bkb_U2->din1(tmp_data_V_3_reg_170);
    cifar_10_mul_32s_bkb_U2->dout(IFM_size_0_fu_117_p2);
    cifar_10_mul_32s_bkb_U3 = new cifar_10_mul_32s_bkb<1,1,32,32,32>("cifar_10_mul_32s_bkb_U3");
    cifar_10_mul_32s_bkb_U3->din0(tmp_data_V_2_reg_164);
    cifar_10_mul_32s_bkb_U3->din1(KER_size_0_reg_187);
    cifar_10_mul_32s_bkb_U3->dout(KER_size_1_fu_121_p2);
    cifar_10_mul_32s_bkb_U4 = new cifar_10_mul_32s_bkb<1,1,32,32,32>("cifar_10_mul_32s_bkb_U4");
    cifar_10_mul_32s_bkb_U4->din0(tmp_data_V_3_reg_170);
    cifar_10_mul_32s_bkb_U4->din1(KER_size_1_reg_197);
    cifar_10_mul_32s_bkb_U4->dout(KER_bound_fu_125_p2);
    cifar_10_mul_32s_bkb_U5 = new cifar_10_mul_32s_bkb<1,1,32,32,32>("cifar_10_mul_32s_bkb_U5");
    cifar_10_mul_32s_bkb_U5->din0(tmp_data_V_4_reg_176);
    cifar_10_mul_32s_bkb_U5->din1(IFM_size_0_reg_192);
    cifar_10_mul_32s_bkb_U5->dout(IFM_size_1_fu_140_p2);
    cifar_10_mul_32s_bkb_U6 = new cifar_10_mul_32s_bkb<1,1,32,32,32>("cifar_10_mul_32s_bkb_U6");
    cifar_10_mul_32s_bkb_U6->din0(reg_102);
    cifar_10_mul_32s_bkb_U6->din1(IFM_size_1_reg_216);
    cifar_10_mul_32s_bkb_U6->dout(IFM_bound_fu_144_p2);
    ...
    sensitive << ( exitcond_fu_129_p2 );
    sensitive << ( ap_enable_reg_pp0_iter1 );
    sensitive << ( exitcond_reg_207 );
    ...
    sensitive << ( exitcond1_fu_149_p2 );
    sensitive << ( ap_enable_reg_pp1_iter1 );
    sensitive << ( exitcond1_reg_226 );
    ...
    SC_METHOD(thread_exitcond1_fu_149_p2);
    sensitive << ( ap_CS_fsm_pp1_stage0 );
    sensitive << ( ap_enable_reg_pp1_iter0 );
    sensitive << ( i_reg_86 );
    sensitive << ( ap_block_pp1_stage0_11001 );
    sensitive << ( IFM_bound_reg_221 );

    SC_METHOD(thread_exitcond_fu_129_p2);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( ap_enable_reg_pp0_iter0 );
    sensitive << ( i1_reg_75 );
    sensitive << ( ap_block_pp0_stage0_11001 );
    sensitive << ( KER_bound_reg_202 );

    SC_METHOD(thread_i_17_fu_154_p2);
    sensitive << ( i_reg_86 );
    ...
    sc_trace(mVcdFile, exitcond1_fu_149_p2, "exitcond1_fu_149_p2");
    sc_trace(mVcdFile, ap_CS_fsm_pp0_stage0, "ap_CS_fsm_pp0_stage0");
    sc_trace(mVcdFile, ap_enable_reg_pp0_iter0, "ap_enable_reg_pp0_iter0");
    sc_trace(mVcdFile, ap_block_pp0_stage0, "ap_block_pp0_stage0");
    sc_trace(mVcdFile, exitcond_fu_129_p2, "exitcond_fu_129_p2");
    sc_trace(mVcdFile, out_stream_V_V_blk_n, "out_stream_V_V_blk_n");
    sc_trace(mVcdFile, ap_enable_reg_pp1_iter1, "ap_enable_reg_pp1_iter1");
    sc_trace(mVcdFile, exitcond1_reg_226, "exitcond1_reg_226");
    sc_trace(mVcdFile, ap_enable_reg_pp0_iter1, "ap_enable_reg_pp0_iter1");
    sc_trace(mVcdFile, exitcond_reg_207, "exitcond_reg_207");
    sc_trace(mVcdFile, i1_reg_75, "i1_reg_75");
    ...
    sc_trace(mVcdFile, tmp_data_V_2_reg_164, "tmp_data_V_2_reg_164");
    sc_trace(mVcdFile, ap_block_state3, "ap_block_state3");
    sc_trace(mVcdFile, tmp_data_V_3_reg_170, "tmp_data_V_3_reg_170");
    sc_trace(mVcdFile, ap_block_state4, "ap_block_state4");
    sc_trace(mVcdFile, tmp_data_V_4_reg_176, "tmp_data_V_4_reg_176");
    sc_trace(mVcdFile, ap_block_state5, "ap_block_state5");
    sc_trace(mVcdFile, tmp_data_V_5_reg_182, "tmp_data_V_5_reg_182");
    sc_trace(mVcdFile, ap_block_state6, "ap_block_state6");
    sc_trace(mVcdFile, KER_size_0_fu_113_p2, "KER_size_0_fu_113_p2");
    sc_trace(mVcdFile, KER_size_0_reg_187, "KER_size_0_reg_187");
    sc_trace(mVcdFile, ap_block_state8, "ap_block_state8");
    sc_trace(mVcdFile, IFM_size_0_fu_117_p2, "IFM_size_0_fu_117_p2");
    sc_trace(mVcdFile, IFM_size_0_reg_192, "IFM_size_0_reg_192");
    sc_trace(mVcdFile, KER_size_1_fu_121_p2, "KER_size_1_fu_121_p2");
    sc_trace(mVcdFile, KER_size_1_reg_197, "KER_size_1_reg_197");
    sc_trace(mVcdFile, ap_CS_fsm_state9, "ap_CS_fsm_state9");
    sc_trace(mVcdFile, KER_bound_fu_125_p2, "KER_bound_fu_125_p2");
    sc_trace(mVcdFile, KER_bound_reg_202, "KER_bound_reg_202");
    sc_trace(mVcdFile, ap_CS_fsm_state10, "ap_CS_fsm_state10");
    sc_trace(mVcdFile, i_1_fu_134_p2, "i_1_fu_134_p2");
    sc_trace(mVcdFile, IFM_size_1_fu_140_p2, "IFM_size_1_fu_140_p2");
    sc_trace(mVcdFile, IFM_size_1_reg_216, "IFM_size_1_reg_216");
    sc_trace(mVcdFile, ap_CS_fsm_state14, "ap_CS_fsm_state14");
    sc_trace(mVcdFile, IFM_bound_fu_144_p2, "IFM_bound_fu_144_p2");
    sc_trace(mVcdFile, IFM_bound_reg_221, "IFM_bound_reg_221");
    sc_trace(mVcdFile, ap_CS_fsm_state15, "ap_CS_fsm_state15");
    sc_trace(mVcdFile, i_17_fu_154_p2, "i_17_fu_154_p2");
...
AXI_DMA_SLAVE::~AXI_DMA_SLAVE() {
    ...
    delete cifar_10_mul_32s_bkb_U1;
    delete cifar_10_mul_32s_bkb_U2;
    delete cifar_10_mul_32s_bkb_U3;
    delete cifar_10_mul_32s_bkb_U4;
    delete cifar_10_mul_32s_bkb_U5;
    delete cifar_10_mul_32s_bkb_U6;
}
...
void AXI_DMA_SLAVE::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         ...
         esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_fu_129_p2.read()) && 
         esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0))) {
        i1_reg_75 = i_1_fu_134_p2.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state10.read())) {
        i1_reg_75 = ap_const_lv32_0;
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage0.read()) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, exitcond1_fu_149_p2.read()) && 
         esl_seteq<1,1,1>(ap_block_pp1_stage0_11001.read(), ap_const_boolean_0))) {
        i_reg_86 = i_17_fu_154_p2.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state15.read())) {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state15.read())) {
        IFM_bound_reg_221 = IFM_bound_fu_144_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()) && !(esl_seteq<1,1,1>(ap_const_logic_0, in_stream_V_data_V_0_vld_out.read()) || esl_seteq<1,1,1>(ap_const_logic_0, out_stream_V_V_full_n.read())) && esl_seteq<1,1,1>(ap_const_lv1_1, tmp_s_reg_160.read()))) {
        IFM_size_0_reg_192 = IFM_size_0_fu_117_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state14.read())) {
        IFM_size_1_reg_216 = IFM_size_1_fu_140_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state10.read())) {
        KER_bound_reg_202 = KER_bound_fu_125_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()) && !(esl_seteq<1,1,1>(ap_const_logic_0, in_stream_V_data_V_0_vld_out.read()) || esl_seteq<1,1,1>(ap_const_logic_0, out_stream_V_V_full_n.read())) && esl_seteq<1,1,1>(ap_const_lv1_0, tmp_s_reg_160.read()))) {
        KER_size_0_reg_187 = KER_size_0_fu_113_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
        KER_size_1_reg_197 = KER_size_1_fu_121_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage0_11001.read(), ap_const_boolean_0))) {
        exitcond1_reg_226 = exitcond1_fu_149_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0))) {
        exitcond_reg_207 = exitcond_fu_129_p2.read();
    }
  ...
  esl_seteq<1,1,1>(ap_const_lv1_0, exitcond1_fu_149_p2.read()) && 
  esl_seteq<1,1,1>(ap_block_pp1_stage0_11001.read(), ap_const_boolean_0)))) {
        reg_102 = in_stream_V_data_V_0_data_out.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && !(esl_seteq<1,1,1>(ap_const_logic_0, in_stream_V_data_V_0_vld_out.read()) || esl_seteq<1,1,1>(ap_const_logic_0, out_stream_V_V_full_n.read())))) {
        tmp_data_V_2_reg_164 = in_stream_V_data_V_0_data_out.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()) && !(esl_seteq<1,1,1>(ap_const_logic_0, in_stream_V_data_V_0_vld_out.read()) || esl_seteq<1,1,1>(ap_const_logic_0, out_stream_V_V_full_n.read())))) {
        tmp_data_V_3_reg_170 = in_stream_V_data_V_0_data_out.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read()) && !(esl_seteq<1,1,1>(ap_const_logic_0, in_stream_V_data_V_0_vld_out.read()) || esl_seteq<1,1,1>(ap_const_logic_0, out_stream_V_V_full_n.read())))) {
        tmp_data_V_4_reg_176 = in_stream_V_data_V_0_data_out.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read()) && !(esl_seteq<1,1,1>(ap_const_logic_0, in_stream_V_data_V_0_vld_out.read()) || esl_seteq<1,1,1>(ap_const_logic_0, out_stream_V_V_full_n.read())))) {
        tmp_data_V_5_reg_182 = in_stream_V_data_V_0_data_out.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && !(esl_seteq<1,1,1>(ap_const_logic_0, real_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, in_stream_V_data_V_0_vld_out.read()) || esl_seteq<1,1,1>(ap_const_logic_0, out_stream_V_V_full_n.read())))) {
        tmp_s_reg_160 = tmp_s_fu_107_p2.read();
    }
}
...
void AXI_DMA_SLAVE::thread_ap_CS_fsm_state14() {
    ap_CS_fsm_state14 = ap_CS_fsm.read()[12];
}

void AXI_DMA_SLAVE::thread_ap_CS_fsm_state15() {
...
void AXI_DMA_SLAVE::thread_ap_block_pp0_stage0_01001() {
  ...
  esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_reg_207.read()) && 
...
void AXI_DMA_SLAVE::thread_ap_block_pp1_stage0_01001() {
  ...
  esl_seteq<1,1,1>(ap_const_lv1_0, exitcond1_reg_226.read()) && 
  esl_seteq<1,1,1>(ap_const_logic_0, out_stream_V_V_full_n.read())));
}
...
void AXI_DMA_SLAVE::thread_ap_block_state11_pp0_stage0_iter0() {
    ap_block_state11_pp0_stage0_iter0 = (esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_fu_129_p2.read()) && esl_seteq<1,1,1>(ap_const_logic_0, in_stream_V_data_V_0_vld_out.read()));
}

void AXI_DMA_SLAVE::thread_ap_block_state12_pp0_stage0_iter1() {
    ap_block_state12_pp0_stage0_iter1 = (esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_reg_207.read()) && esl_seteq<1,1,1>(ap_const_logic_0, out_stream_V_V_full_n.read()));
}

void AXI_DMA_SLAVE::thread_ap_block_state16_pp1_stage0_iter0() {
    ap_block_state16_pp1_stage0_iter0 = (esl_seteq<1,1,1>(ap_const_lv1_0, exitcond1_fu_149_p2.read()) && esl_seteq<1,1,1>(ap_const_logic_0, in_stream_V_data_V_0_vld_out.read()));
}

void AXI_DMA_SLAVE::thread_ap_block_state17_pp1_stage0_iter1() {
    ap_block_state17_pp1_stage0_iter1 = (esl_seteq<1,1,1>(ap_const_lv1_0, exitcond1_reg_226.read()) && esl_seteq<1,1,1>(ap_const_logic_0, out_stream_V_V_full_n.read()));
}
...
void AXI_DMA_SLAVE::thread_ap_condition_pp0_exit_iter0_state11() {
    if (esl_seteq<1,1,1>(ap_const_lv1_1, exitcond_fu_129_p2.read())) {
...
void AXI_DMA_SLAVE::thread_ap_condition_pp1_exit_iter0_state16() {
    if (esl_seteq<1,1,1>(ap_const_lv1_1, exitcond1_fu_149_p2.read())) {
...
void AXI_DMA_SLAVE::thread_exitcond1_fu_149_p2() {
    exitcond1_fu_149_p2 = (!i_reg_86.read().is_01() || !IFM_bound_reg_221.read().is_01())? sc_lv<1>(): sc_lv<1>(i_reg_86.read() == IFM_bound_reg_221.read());
}

void AXI_DMA_SLAVE::thread_exitcond_fu_129_p2() {
    exitcond_fu_129_p2 = (!i1_reg_75.read().is_01() || !KER_bound_reg_202.read().is_01())? sc_lv<1>(): sc_lv<1>(i1_reg_75.read() == KER_bound_reg_202.read());
}

void AXI_DMA_SLAVE::thread_i_17_fu_154_p2() {
    i_17_fu_154_p2 = (!i_reg_86.read().is_01() || !ap_const_lv32_1.is_01())? sc_lv<32>(): (sc_biguint<32>(i_reg_86.read()) + sc_biguint<32>(ap_const_lv32_1));
}

void AXI_DMA_SLAVE::thread_i_1_fu_134_p2() {
    i_1_fu_134_p2 = (!i1_reg_75.read().is_01() || !ap_const_lv32_1.is_01())? sc_lv<32>(): (sc_biguint<32>(i1_reg_75.read()) + sc_biguint<32>(ap_const_lv32_1));
}
...
void AXI_DMA_SLAVE::thread_out_stream_V_V_din() {
    if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
        ...
        out_stream_V_V_din = reg_102.read();
...
void AXI_DMA_SLAVE::thread_tmp_s_fu_107_p2() {
    tmp_s_fu_107_p2 = (!in_stream_V_data_V_0_data_out.read().is_01() || !ap_const_lv32_0.is_01())? sc_lv<1>(): sc_lv<1>(in_stream_V_data_V_0_data_out.read() == ap_const_lv32_0);
}
...
void AXI_DMA_SLAVE::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 128 : 
            ...
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()) && !(esl_seteq<1,1,1>(ap_const_logic_0, in_stream_V_data_V_0_vld_out.read()) || esl_seteq<1,1,1>(ap_const_logic_0, out_stream_V_V_full_n.read())) && esl_seteq<1,1,1>(ap_const_lv1_0, tmp_s_reg_160.read()))) {
        ...
        case 512 : 
            ...
            break;
        case 1024 : 
            if (!(esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_subdone.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_1, exitcond_fu_129_p2.read()))) {
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_subdone.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_1, exitcond_fu_129_p2.read()))) {
        ...
        case 8192 : 
            ...
            break;
        case 16384 : 
            if (!(esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage0_subdone.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_1, exitcond1_fu_149_p2.read()))) {
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage0_subdone.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_1, exitcond1_fu_149_p2.read()))) {
                ap_NS_fsm = ap_ST_fsm_state13;
            } else {
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            }
