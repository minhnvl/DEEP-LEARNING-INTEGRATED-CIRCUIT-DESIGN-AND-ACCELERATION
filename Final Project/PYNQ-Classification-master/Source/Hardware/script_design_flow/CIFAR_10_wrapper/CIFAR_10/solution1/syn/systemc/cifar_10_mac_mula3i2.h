...
// ==============================================================
#ifndef __cifar_10_mac_mula3i2__HH__
#define __cifar_10_mac_mula3i2__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cifar_10_mac_mula3i2) {
    ...
    SC_CTOR(cifar_10_mac_mula3i2):  simcore_mac_0_U ("simcore_mac_0_U") {
