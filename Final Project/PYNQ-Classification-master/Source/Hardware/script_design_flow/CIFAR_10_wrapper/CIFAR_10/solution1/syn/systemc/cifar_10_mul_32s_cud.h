...
// ==============================================================
#ifndef __cifar_10_mul_32s_cud__HH__
#define __cifar_10_mul_32s_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cifar_10_mul_32s_cud) {
    ...
    SC_CTOR(cifar_10_mul_32s_cud):  ACMP_smul_su_U ("ACMP_smul_su_U") {
